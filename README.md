...
![Boyut](https://img.shields.io/badge/boyut-~2%2C4%20MB-334155)
...
| 📂 **Klasörler** | Klasörleri ve fotoğrafları tek tek ya da toplu seçme, kes/kopyala/yapıştır, klasör birleştirme, ad değiştirme, sıralama (yeniden eskiye, eskiden yeniye, ada göre) |
...
1. **Modüller** ekranından **Fişler** modülüne girin.
...
Üstteki yol çubuğu (**Modüller > Fişler > klasör > …**) ve soldan açılan menü, nerede olduğunuzu kaybetmeden gezinmenizi sağlar.
...
Uygulama açılışta — en fazla 6 saatte bir — bu depodaki `latest.json` dosyasına bakar. Yeni sürüm varsa ekranın üstünde bir şerit gösterir:
...
> **Güncelleme denetimini istemiyorsanız:** **Ayarlar > Güncelleme**'den kapatın. Kapalıyken uygulama internete hiç çıkmaz; yeni sürümü [Sürümler](../../releases) sayfasından elle indirip kurarsınız.
...
**Ayarlar > Güncelleme**'den kapatırsanız uygulama internete **hiç** çıkmaz.
